# -*- coding: utf-8 -*-
"""
Created on Fri Jul  5 02:52:47 2024
    ...
    def __call__(self, model, loss):
        ...
        for layer in tqdm.tqdm(model.layers[::-1]):
            ...
            if isinstance(layer, layers.Layer):
                ...
                layer.momentum["b"] = self.momentum_average(layer.momentum["b"], layer.w_gradient)
    ...
    def __call__(self, model, loss):
        ...
        for layer in tqdm.tqdm(model.layers[::-1]):
            ...
            if isinstance(layer, layers.Layer):
                ...
                layer.adaam["w2"] = self.rms_average(layer.adam["w2"], layer.w_gradient)
                layer.adaam["b2"] = self.rms_average(layer.adam["b2"], layer.b_gradient)
